                  ...
                  <div className="rounded-md border bg-background p-4 space-y-1">
                    ...
                    <div className="pt-2 flex flex-col gap-4">
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="border border-white/10 rounded-md overflow-hidden bg-black/50 cyber-card">
                            <div className="bg-[#0f172a] px-3 py-2 border-b border-white/5 flex items-center justify-between">
                              <span className="text-[10px] uppercase font-mono tracking-widest text-cyan-400">Visual Context</span>
                              <a 
                                href={url} 
                                target="_blank" 
                                rel="noreferrer"
                              ...
                              >
                                [ View Full Screenshot ] <ExternalLink className="w-3 h-3" />
                              </a>
                            </div>
                            <div className="p-4 flex justify-center bg-[#06060a] relative group overflow-hidden">
                              <img 
                                src={url} 
                                alt="Issue Visual Context" 
                                className="max-h-[500px] w-auto border border-white/5 shadow-2xl transition-transform duration-500 group-hover:scale-[1.02]" 
                              />
                  ...
                  {issue.ai && (
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 border-b border-cyan-500/20 pb-2 mb-2">
                        ...
                        <h4 className="text-sm font-bold uppercase tracking-wider text-cyan-500/80">AI Analysis & Debugger</h4>
                      </div>

                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-4">
                          <div className="rounded-md border border-cyan-500/10 bg-cyan-500/[0.02] p-4">
                            <div className="flex items-center gap-1.5 mb-2">
                              <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground/60">🧠 Simple Explanation</span>
                            </div>
                            <p className="text-sm leading-relaxed">{issue.ai.explanation}</p>
                          </div>

                          <div className="rounded-md border border-amber-500/10 bg-amber-500/[0.02] p-4">
                            <div className="flex items-center gap-1.5 mb-2">
                              <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground/60">⚠️ Why it happens</span>
                            </div>
                            <p className="text-sm leading-relaxed">{issue.ai.rootCause}</p>
                          </div>
                        </div>

                        <div className="space-y-4">
                          <div className="rounded-md border border-emerald-500/10 bg-emerald-500/[0.02] p-4">
                            <div className="flex items-center gap-1.5 mb-2">
                              <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground/60">🛠️ Fix Suggestion</span>
                            </div>
                            <p className="text-sm leading-relaxed">{issue.ai.fix}</p>
                          </div>

                          <div className="rounded-md border border-indigo-500/10 bg-indigo-500/[0.02] p-4">
                            <div className="flex items-center gap-1.5 mb-2">
                              <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground/60">📋 Step-by-Step Guide</span>
                            </div>
                            <ul className="text-sm space-y-1.5 ml-4 list-disc marker:text-indigo-500/50">
                              {issue.ai.steps.map((step, idx) => (
